...
//go:generate go run github.com/golang/mock/mockgen -package mocks -destination mocks/mocks.go github.com/DavinZhang/juju/apiserver/common/charms State,Application,Charm,Model
