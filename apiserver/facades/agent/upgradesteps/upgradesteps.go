...
//go:generate go run github.com/golang/mock/mockgen -package mocks -destination mocks/upgradesteps_mock.go github.com/DavinZhang/juju/apiserver/facades/agent/upgradesteps UpgradeStepsState,Machine,Unit
//go:generate go run github.com/golang/mock/mockgen -package mocks -destination mocks/state_mock.go github.com/DavinZhang/juju/state EntityFinder,Entity
