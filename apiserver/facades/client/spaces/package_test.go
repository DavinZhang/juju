...
import (
	...
	environmocks "github.com/DavinZhang/juju/environs/mocks"
)

//go:generate go run github.com/golang/mock/mockgen -package spaces -destination package_mock_test.go github.com/DavinZhang/juju/apiserver/facades/client/spaces Backing,BlockChecker,Machine,RenameSpace,RenameSpaceState,Settings,OpFactory,RemoveSpace,Subnet,Constraints,MovingSubnet,MoveSubnetsOp,Address,Unit,ReloadSpaces,ReloadSpacesState,ReloadSpacesEnviron,EnvironSpaces,AuthorizerState,Bindings
