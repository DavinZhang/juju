...
// Source: github.com/DavinZhang/juju/state/migrations (interfaces: MigrationFirewallRule,FirewallRuleSource,FirewallRulesModel)
...
func (mr *MockFirewallRulesModelMockRecorder) AddFirewallRule(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
