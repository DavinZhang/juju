...
//go:generate go run github.com/golang/mock/mockgen -package mocks -destination mocks/lxdprofile_mock.go github.com/DavinZhang/juju/core/lxdprofile LXDProfiler,LXDProfile
