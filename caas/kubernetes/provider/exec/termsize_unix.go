...
//go:generate go run github.com/golang/mock/mockgen -package mocks -destination mocks/sizequeue_mock.go github.com/DavinZhang/juju/caas/kubernetes/provider/exec SizeGetter
