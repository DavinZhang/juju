...
//go:generate go run github.com/golang/mock/mockgen -package mocks -destination mocks/exec_mock.go github.com/DavinZhang/juju/caas/kubernetes/provider/exec Executor
//go:generate go run github.com/golang/mock/mockgen -package mocks -destination mocks/uniter_mock.go github.com/DavinZhang/juju/worker/uniter ProviderIDGetter
