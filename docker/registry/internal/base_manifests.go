...
//go:generate go run github.com/golang/mock/mockgen -package mocks -destination mocks/manifests_mock.go github.com/DavinZhang/juju/docker/registry/internal ArchitectureGetter
