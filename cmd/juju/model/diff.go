...
//go:generate go run github.com/golang/mock/mockgen -package mocks -destination ./mocks/diff_mock.go github.com/DavinZhang/juju/cmd/juju/model DiffCommandAPI
