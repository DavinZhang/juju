...
//go:generate go run github.com/golang/mock/mockgen -package mocks -destination ./mocks/branch_mock.go github.com/DavinZhang/juju/cmd/juju/model BranchCommandAPI
