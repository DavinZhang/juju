...
//go:generate go run github.com/golang/mock/mockgen -package mocks -destination mocks/runner_mock.go github.com/DavinZhang/juju/cmd/juju/caas CommandRunner
