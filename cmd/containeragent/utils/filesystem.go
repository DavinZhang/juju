...
//go:generate go run github.com/golang/mock/mockgen -package mocks -destination mocks/file_mock.go github.com/DavinZhang/juju/cmd/containeragent/utils FileReaderWriter
