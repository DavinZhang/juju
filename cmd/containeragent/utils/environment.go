...
//go:generate go run github.com/golang/mock/mockgen -package mocks -destination mocks/environment_mock.go github.com/DavinZhang/juju/cmd/containeragent/utils Environment
