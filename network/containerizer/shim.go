...
//go:generate go run github.com/golang/mock/mockgen -package containerizer -destination bridgepolicy_mock_test.go github.com/DavinZhang/juju/network/containerizer Container,Address,Subnet,LinkLayerDevice
